...
public class TasksRemoteDataSource implements TasksDataSource {
    ...
    static {
        ...
        addTask("Build tower in Pisa", "Ground looks good, no foundation work required.", null);
        addTask("Finish bridge in Tacoma", "Found awesome girders at half the cost!", null);
    }
    ...
    private static void addTask(String title, String description, byte[] image) {
    ...
    public void completeTask(@NonNull Task task) {
        Task completedTask = new Task(task.getTitle(), task.getDescription(), task.getId(), task.getImage(), true);
